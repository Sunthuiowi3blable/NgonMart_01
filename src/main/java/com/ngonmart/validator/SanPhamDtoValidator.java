package com.ngonmart.validator;
...
public class SanPhamDtoValidator implements Validator{
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmpty(errors, "thongTinBaoHanh", "error.thongTinBaoHanh", "Thông tin khác không được trống");
		...
		if(tenDanhMuc.contains("MÓN ĂN ĐẶC BIỆT".toLowerCase())) {
